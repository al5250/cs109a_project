...
def gen_data(anomaly_type=None, length=150, n_change_points=2):
    """
    anomaly_type: string. `Peak` | `Plateau` | `Slope`
    ...
    elif anomaly_type == 'Peak' or anomaly_type == 'Plateau':
